...
jsPlumb.ready(function() {
	...
	$('#Container').click(function() {
		...
		//画出矩形
		if (h < 0 && w >= 0) {
            $("#multipleSelectedRectangle").css({ "height": (-h) + "px", "width": w + "px", "position": "absolute", "left": px + scrollX - 200 + "px", "top": pyy + scrollY - 80 + "px", "opacity": "0.2", "border": "1px dashed #000" });
        }
        else if (h >= 0 && w < 0) {
            $("#multipleSelectedRectangle").css({ "height": h + "px", "width": (-w) + "px", "position": "absolute", "left": pxx + scrollX - 200 + "px", "top": py + scrollY - 80 + "px", "opacity": "0.2", "border": "1px dashed #000" });
        }
        else if (h < 0 && w < 0) {
            $("#multipleSelectedRectangle").css({ "height": (-h) + "px", "width": (-w) + "px", "position": "absolute", "left": pxx + scrollX - 200 + "px", "top": pyy + scrollY - 80 + "px", "opacity": "0.2", "border": "1px dashed #000" });
        }
        else {
            $("#multipleSelectedRectangle").css({ "height": h + "px", "width": w + "px", "position": "absolute", "left": px + scrollX - 200 + "px", "top": py + scrollY - 80 + "px", "opacity": "0.2", "border": "1px dashed #000" });
        }
        if (w < 0) {
            w = 0 - w;
        }
